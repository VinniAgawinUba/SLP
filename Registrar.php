                        ...
                        <div class="col-md-12">
                            <?php include('message.php'); ?>
                                <div class="card-header">
                                    <h4 class="card-title text-center customHome">Registrar</h4>
                                </div>
                                <div>
                                    <!-- FETCH FROM DATABASE -->
                                    <?php
                                    $navbarCategory = "SELECT * FROM students";
                                    ...
                                    if(mysqli_num_rows($navbarCategory_run) > 0)
                                    {
                                        ...
                                        ?>
                                        <ul class="nav-item">
                                            <a class="nav-item" href="projects.php?title=<?=$navItems['id'];?>"><?=$navItems['fname'];?></a>
                                        </ul>
                                        <?php
                                        }
                                    }
